...
from common.filter_utils import (
    apply_all_filters as _apply_all_filters,
    get_filter_context as _get_filter_context
)
...
apply_commande_filters = lambda qs, req: _apply_all_filters(qs, req)
get_filter_context = _get_filter_context
