/**
 * Gestionnaire du bouton hamburger pour l'interface operatConfirme
...
(function() {
    ...
    function log(message, data = {}) {
        ...
        console.log(`🍔 [HamburgerMenu] [${timestamp}] [${pageUrl}] ${message}`, data);
    }
    ...
    function initialize() {
        ...
        log('🔧 Début d\'initialisation du module hamburger');
     ...
     */
    function autoInit() {
        log('🚀 Auto-initialisation du module');
