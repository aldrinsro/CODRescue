...
function initAdvancedFilters(settings) {
    ...
    const filters = [
        ...
        'filter_ville_region',
        'filter_adresse',
        'filter_date_commande_debut',
        'filter_date_commande_fin',
        'filter_date_confirmation_debut',
        'filter_date_confirmation_fin',
        'filter_date_affectation_debut',
        'filter_date_affectation_fin',
        'filter_date_preparation_debut',
        'filter_date_preparation_fin',
        'filter_date_livraison_debut',
        'filter_date_livraison_fin',
        'filter_total_min',
        'filter_total_max',
        'filter_etat',
        'filter_operateur'
...
function applyFilters() {
    ...
    const filterMapping = {
        ...
        'filterDateCommandeDebut': 'filter_date_commande_debut',
        'filterDateCommandeFin': 'filter_date_commande_fin',
        'filterDateConfirmationDebut': 'filter_date_confirmation_debut',
        'filterDateConfirmationFin': 'filter_date_confirmation_fin',
        'filterDateAffectationDebut': 'filter_date_affectation_debut',
        'filterDateAffectationFin': 'filter_date_affectation_fin',
        'filterDatePreparationDebut': 'filter_date_preparation_debut',
        'filterDatePreparationFin': 'filter_date_preparation_fin',
        'filterDateLivraisonDebut': 'filter_date_livraison_debut',
        'filterDateLivraisonFin': 'filter_date_livraison_fin',
